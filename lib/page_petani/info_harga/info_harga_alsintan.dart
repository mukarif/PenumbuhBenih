...
class InfoHargaAlsintan extends StatefulWidget {
  const InfoHargaAlsintan({Key key}) : super(key: key);

  @override
  _InfoHargaAlsintanState createState() => _InfoHargaAlsintanState();
}

class _InfoHargaAlsintanState extends State<InfoHargaAlsintan> {
