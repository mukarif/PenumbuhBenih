...
import 'package:petani/page_petani/forum/forum.dart';
import 'package:petani/page_petani/hasil_panen/hasil_panen.dart';
import 'package:petani/page_petani/info_cuaca/info_cuaca.dart';
        ...
        children: [
          ...
          Column(
            ...
            children: [
              InkWell(
                child: Image.asset(
                  'assets/icons/info_cuaca.png',
                  height: 80.0,
                  width: 80.0,
                ),
                onTap: () {
                  Get.to(() => const InfoCuaca());
                },
              ),
              const Text(
                "Info\nCuaca",
