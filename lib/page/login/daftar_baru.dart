...
class _DaftarBaruState extends State<DaftarBaru> {
  ...
  TextEditingController namaPoktan = TextEditingController();
  TextEditingController alamatLengkap = TextEditingController();
  TextEditingController pass = TextEditingController();
  TextEditingController email = TextEditingController();
  TextEditingController repass = TextEditingController();

  String bentukOrganisasi;
  String tglPembentukan;
  String wilayahKerja;
  String provinsi;
  String kabupatenKota;
  String kecamatan;
  String desa;
  String gabunganPoktan;
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Form(
                        ...
                        child: Column(
                          children: [
                            _tff("Nama kelompok tani", "Nama kelompok tani",
                                namaPoktan),
                            _box(),
                            _formField("Bentuk organisasi", bentukOrganisasi,
                                _dropdownValues),
                            _box(),
                            _formField("Tanggal pembentukan", tglPembentukan,
                                _dropdownValues),
                            _box(),
                            _formField(
                                "Wilayah kerja", wilayahKerja, _dropdownValues),
                            _box(),
                            _tff("Alamat lengkap", "Alamat lengkap",
                                alamatLengkap),
                            _box(),
                            _formField("Provinsi", provinsi, _dropdownValues),
                            _box(),
                            _formField("Kabupaten/Kota", kabupatenKota,
                                _dropdownValues),
                            _box(),
                            ...
                            _box(),
                            _gabunganPoktan(
                                "Pilih gabungan kelompok tani (jika ada)",
                                gabunganPoktan,
                                _dropdownValues),
                            _box(),
                            const Divider(
  ...
  Widget _gabunganPoktan(String hint, String onChange, List<String> list) {
    return Center(
      child: Container(
        padding: const EdgeInsets.symmetric(horizontal: 20.0),
        decoration: BoxDecoration(
