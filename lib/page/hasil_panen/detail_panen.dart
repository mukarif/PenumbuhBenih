...
class DetailPanenKomoditas extends StatefulWidget {
  const DetailPanenKomoditas({Key key}) : super(key: key);

  @override
  _DetailPanenKomoditasState createState() => _DetailPanenKomoditasState();
}

class _DetailPanenKomoditasState extends State<DetailPanenKomoditas> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _box(),
                _pembeli("Pembeli", "Belum Terjual"),
                _box(),
                _buttonJual(),
                const SizedBox(
                  height: 5,
